...
if get(g:, 'include_next_and_previous_section', v:false)
...
if get(g:, 'include_diff_section', v:false)
...
if get(g:, 'include_line_operations_section', v:true)
...
if get(g:, 'include_option_toggling_section', v:false)
...
if get(g:, 'include_encoding_and_decoding_section', v:true)
